...
public class ManageSearchOrganizationalUnitRoute implements Route {
    private static final Logger LOGGER = LoggerFactory.getLogger(ManageSearchOrganizationalUnitRoute.class);
    private Ldap ldap;
    @Inject
    public ManageSearchOrganizationalUnitRoute(Ldap ldap){
        this.ldap=ldap;
    }
