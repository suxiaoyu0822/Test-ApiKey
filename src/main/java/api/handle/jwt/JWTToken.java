...
//            algorithm = Algorithm.RSA256(SECRET);
        }else if (alg.equals("RS384")){
//            algorithm = Algorithm.RSA384(SECRET);
        }else if (alg.equals("RS512")){
//            algorithm = Algorithm.RSA512(SECRET);
...
//        String token = jwtToken.createToken(alg,typ,iss,sub,aud,nbf,exp,jti);
        String token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ5eHMiLCJhdWQiOiJ4eXMiLCJuYmYiOjE1NDI4MDIzNzgsImlzcyI6InN4eSIsImV4cCI6MTU0MzY2NjM3OCwiaWF0IjoxNTQyODAyMzc4LCJqdGkiOiIxMjM0NTY3ODkifQ.2iZm3Fv9BIG7mh_mnsViFsVAaoSslBXsbDVVtOYpGvQ\n";
